...
DutyCycle = GetCurrentTaskCycleCount();
void room_control_on_uart_receive(char received_char)
{
    switch (received_char) {
        ...
        case '1':
            ...
            uart_send_string("Controlador de Sala v2.0Estado inicial:Lámpara: 10% Puerta: Cerrada\r\n");
            break;
        case '2':
            tim3_ch1_pwm_set_duty_cycle(20);
            uart_send_string("Controlador de Sala v2.0Estado inicial:Lámpara: 20% Puerta: Cerrada\r\n");
            break;
        case '3':
            tim3_ch1_pwm_set_duty_cycle(30);
            uart_send_string("Controlador de Sala v2.0Estado inicial:Lámpara: 30% Puerta: Cerrada\r\n");
            break;
        case '4':
            tim3_ch1_pwm_set_duty_cycle(40);
            uart_send_string("Controlador de Sala v2.0Estado inicial:Lámpara: 40% Puerta: Cerrada\r\n");
            break;
        case '5':
            tim3_ch1_pwm_set_duty_cycle(50);
            uart_send_string("Controlador de Sala v2.0Estado inicial:Lámpara: 50% Puerta: Cerrada\r\n");
            break;
        case 's':
        DutyCycle = GetCurrentTaskCycleCount();
        ...
        uart_send_string(" o: Abrir puerta (ocupar salar)\r\n");
        ...
        case 's':
        DutyCycle = GetCurrentTaskCycleCount();
        uart_send_string("Estado actual: - Lámpara:"DustyCycle"%-Puerta: Cerrada\r\n");
        break;
        case '0':
            current_state = ROOM_IDLE;
            tim3_ch1_pwm_set_duty_cycle(0);
